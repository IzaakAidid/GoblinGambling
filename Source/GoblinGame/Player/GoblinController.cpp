...
void AGoblinController::SetupInputComponent()
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(InputComponent))
	{
		...
		EnhancedInputComponent->BindAction(PauseAction, ETriggerEvent::Started, this, &AGoblinController::Server_PlayerPause);
	}
}
...
void AGoblinController::Server_PlayerPause_Implementation()
{
	if (PlayerGoblin)
	{
		PlayerGoblin->PlayerPauseGame();
	}
}
